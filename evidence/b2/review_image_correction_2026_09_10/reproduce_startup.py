...
Use the archived a32b1fe harness to retain the prior independent counterexample.
...
FW = R / "firmware/b2"
H = R / "tb/b2/hostapp"
source = subprocess.check_output(["git", "-C", str(R), "show", "a32b1fe:tb/b2/hostapp/hostapp.c"], text=True)
