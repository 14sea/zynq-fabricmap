...
* **the real run** — the ECO differential has to parse actual frames, so those cases read
  `gate_runs/claimb_round1_carrier_2026_08_13_erratum003/`. In a tree where LFS content has not been
...
REAL_RUN = REPO_ROOT / "gate_runs/claimb_round1_carrier_2026_08_13_erratum003"
