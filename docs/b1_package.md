...
Report (the committed, UNQUALIFIED state): `evidence/b1/tests/test_report_2026-09-06T152151Z.json` (schema `b1_test_report`, package `B1 v2.4.3`) — ran **1456**, skipped **0**, `OK`; `head_at_run` `64d5f0f82266`, `worktree_dirty` False; instrument `689dde1dad37` = pinned, dirty False; **`clean_tree_proof: True`**. Report (the QUALIFIED state, a modelled B1Q record pinned into the working-tree manifest by the production refresh — `host/b1_qualified_state_check.py`): `evidence/b1/tests/qualified_state_report_2026-09-06T152152Z.json` — ran **1451**, skipped **27** (the carrier-authority gate on the temporary manifest; those tests do not read it), `OK (skipped=27)`, committed manifest `38363973c10c4824…` → pinned `ce8a5fa3dd9582b1…`, tree restored True. The first qualified-state run (`qualified_state_report_2026-09-06T151352Z.json`, 1 failure) is kept: it caught the last state-dependent assertion, fixed in `64d5f0f`. Earlier reports are kept as the records of the earlier packages.
